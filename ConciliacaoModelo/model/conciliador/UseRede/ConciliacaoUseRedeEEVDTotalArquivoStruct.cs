...
{
    [Table("conciliador_userede_eevd_totalarquivo")]
    public class ConciliacaoUseRedeEEVDTotalArquivoStruct : BaseUGrav
    {
        ...
        [Column("total_registro")]
        public decimal is_total_registro { get; set; }
        ...
        */
        public ConciliacaoUseRedeEEVDTotalArquivoStruct()
        {
