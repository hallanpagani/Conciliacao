...
{
    [Table("conciliador_userede_eevc_resumooperacao")]
    public class ConciliacaoUseRedeEEVCResumoOperacaoStructListar 
    {
        ...
        public string is_numero_resumo_venda { get; set; }

        [Column("quantidade_resumo_vendas")]
        public string is_quantidade_resumo_vendas { get; set; }
        ...
        [Column("tipo_resumo")]
        public string is_tipo_resumo { get; set; }
        ...
        [Column("valor_rejeitado")]
        public decimal is_valor_rejeitado { get; set; }
        ...
        */
        public ConciliacaoUseRedeEEVCResumoOperacaoStructListar()
        {
