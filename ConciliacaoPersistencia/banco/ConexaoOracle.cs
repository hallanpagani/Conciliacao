...
namespace ConciliacaoPersistencia.banco
{
    ...
    {
        private OracleConnection conexaoMySql = null;

        public static ConexaoOracle Get(string connectionString)
        {
            ConexaoOracle conexao = new ConexaoOracle(connectionString);
            conexao.Connect();
            return conexao;
        }

        public ConexaoOracle(string connectionString)
        {
            this.conexaoMySql = new OracleConnection(connectionString);
        }
