...
namespace Conciliacao.Models.Relatorios
{
    public class TransacaoRedeViewModel
    {
        ...
        public List<ConciliacaoTransacaoRede> TransacaoArquivos { get; set; }

        public List<ArquivoDeCriticas> ArquivosCriticas { get; set; }
        public List<ExtratoPagamento> ArquivosPagamento { get; set; }

        public TransacaoRedeViewModel()
        {
            filtro_rede = null;
            filtro_nm_rede = "";
            ...
            tp_cartao = 0;
            tp_situacao = 2;
            ArquivosCriticas = new List<ArquivoDeCriticas>();
            ArquivosPagamento = new List<ExtratoPagamento>();
        }
    }
}